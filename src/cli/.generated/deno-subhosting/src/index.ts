...
export const compilerOptions = /** Compiler options to be used when building the deployment.
...
will be applied. */
z.object({experimentalDecorators: /** Whether to enable TypeScript's experimental decorators. If set to `false`,
...
export const asset = z.discriminatedUnion('status', file.and(z.object({kind: z.string()})),
symlink.merge(z.object({kind: z.string()})));
export const assets = /** A map whose key represents a file path, and the value is an asset that
...
export const deploymentPermissions = /** Permissions to be set for the deployment.
...
network requests to. */
z.object({net: /** A list of IP addresses that the deployment is allowed to make outbound
network requests to.
...
export const deploymentPermissionsOverwrite = /** Permissions to be overwritten for the deployment's existing permissions.
...
z.boolean(),
z.unknown()]);
export const analytics = /** Project analytics data */
z.object({fields: z.array(analyticsFieldSchema),
...
databases: /** The KV databases that this deployment has access to.
...
export const redeployRequest = z.object({envVars: /** A dictionary of environment variables to be set in the runtime environment
of the deployment.
...
createdAt: z.string(),
updatedAt: z.string()});
export const provisioningStatus = z.discriminatedUnion('status', z.object({code: z.string()}),
...
export const CreateOrganizationsOrganizationIdProjects = () => {
      const { control, handleSubmit } = useForm({
        resolver: zodResolver(z.object({name: /** The name of the project. This must be globally unique. If this is `null`,
a random unique name will be generated. */
z.string().optional(),
description: /** The description of the project. If this is `null`, an empty string will be
set. */
...
export const CreateDeploymentsDeploymentIdRedeploy = () => {
      const { control, handleSubmit } = useForm({
        resolver: zodResolver(z.object({envVars: /** A dictionary of environment variables to be set in the runtime environment
of the deployment.
...
export const injectedRtkApi = createApi({
      ...
      endpoints: (build) => ({getApiOrganizationsOrganizationId: build.query<GetApiOrganizationsOrganizationIdResponse,GetApiOrganizationsOrganizationIdResponse>
    ({query: (queryArg) => ({path: `/organizations/${queryArg.organizationId}`,
method: GET,
params: {
organizationId: queryArg.organizationId
}})}),
getApiOrganizationsOrganizationIdAnalytics: build.query<GetApiOrganizationsOrganizationIdAnalyticsResponse,GetApiOrganizationsOrganizationIdAnalyticsResponse>
    ({query: (queryArg) => ({path: `/organizations/${queryArg.organizationId}/analytics`,
method: GET,
params: {
organizationId: queryArg.organizationId,
...
getApiOrganizationsOrganizationIdProjects: build.query<GetApiOrganizationsOrganizationIdProjectsResponse,GetApiOrganizationsOrganizationIdProjectsResponse>
    ({query: (queryArg) => ({path: `/organizations/${queryArg.organizationId}/projects`,
method: GET,
params: {
page: queryArg.page,
...
postApiOrganizationsOrganizationIdProjects: build.mutation<PostApiOrganizationsOrganizationIdProjectsResponse,PostApiOrganizationsOrganizationIdProjectsResponse>
    ({query: (queryArg) => ({path: `/organizations/${queryArg.organizationId}/projects`,
method: POST,
params: {
organizationId: queryArg.organizationId
...
body: queryArg.body})}),
getApiOrganizationsOrganizationIdDatabases: build.query<GetApiOrganizationsOrganizationIdDatabasesResponse,GetApiOrganizationsOrganizationIdDatabasesResponse>
    ({query: (queryArg) => ({path: `/organizations/${queryArg.organizationId}/databases`,
method: GET,
params: {
page: queryArg.page,
limit: queryArg.limit,
...
postApiOrganizationsOrganizationIdDatabases: build.mutation<PostApiOrganizationsOrganizationIdDatabasesResponse,PostApiOrganizationsOrganizationIdDatabasesResponse>
    ({query: (queryArg) => ({path: `/organizations/${queryArg.organizationId}/databases`,
method: POST,
params: {
organizationId: queryArg.organizationId
...
body: queryArg.body})}),
patchApiDatabasesDatabaseId: build.mutation<PatchApiDatabasesDatabaseIdResponse,PatchApiDatabasesDatabaseIdResponse>
    ({query: (queryArg) => ({path: `/databases/${queryArg.databaseId}`,
method: PATCH,
params: {
databaseId: queryArg.databaseId
},
body: queryArg.body})}),
getApiProjectsProjectId: build.query<GetApiProjectsProjectIdResponse,GetApiProjectsProjectIdResponse>
    ({query: (queryArg) => ({path: `/projects/${queryArg.projectId}`,
method: GET,
params: {
projectId: queryArg.projectId
}})}),
deleteApiProjectsProjectId: build.mutation<DeleteApiProjectsProjectIdResponse,DeleteApiProjectsProjectIdResponse>
    ({query: (queryArg) => ({path: `/projects/${queryArg.projectId}`,
method: DELETE,
params: {
projectId: queryArg.projectId
}})}),
patchApiProjectsProjectId: build.mutation<PatchApiProjectsProjectIdResponse,PatchApiProjectsProjectIdResponse>
    ({query: (queryArg) => ({path: `/projects/${queryArg.projectId}`,
method: PATCH,
params: {
projectId: queryArg.projectId
...
body: queryArg.body})}),
getApiProjectsProjectIdAnalytics: build.query<GetApiProjectsProjectIdAnalyticsResponse,GetApiProjectsProjectIdAnalyticsResponse>
    ({query: (queryArg) => ({path: `/projects/${queryArg.projectId}/analytics`,
method: GET,
params: {
projectId: queryArg.projectId,
since: queryArg.since,
...
getApiProjectsProjectIdDeployments: build.query<GetApiProjectsProjectIdDeploymentsResponse,GetApiProjectsProjectIdDeploymentsResponse>
    ({query: (queryArg) => ({path: `/projects/${queryArg.projectId}/deployments`,
method: GET,
params: {
page: queryArg.page,
limit: queryArg.limit,
...
postApiProjectsProjectIdDeployments: build.mutation<PostApiProjectsProjectIdDeploymentsResponse,PostApiProjectsProjectIdDeploymentsResponse>
    ({query: (queryArg) => ({path: `/projects/${queryArg.projectId}/deployments`,
method: POST,
params: {
projectId: queryArg.projectId
...
body: queryArg.body})}),
postApiDeploymentsDeploymentIdRedeploy: build.mutation<PostApiDeploymentsDeploymentIdRedeployResponse,PostApiDeploymentsDeploymentIdRedeployResponse>
    ({query: (queryArg) => ({path: `/deployments/${queryArg.deploymentId}/redeploy`,
method: POST,
params: {
deploymentId: queryArg.deploymentId
},
body: queryArg.body})}),
getApiDeploymentsDeploymentId: build.query<GetApiDeploymentsDeploymentIdResponse,GetApiDeploymentsDeploymentIdResponse>
    ({query: (queryArg) => ({path: `/deployments/${queryArg.deploymentId}`,
method: GET,
params: {
deploymentId: queryArg.deploymentId
}})}),
deleteApiDeploymentsDeploymentId: build.mutation<DeleteApiDeploymentsDeploymentIdResponse,DeleteApiDeploymentsDeploymentIdResponse>
    ({query: (queryArg) => ({path: `/deployments/${queryArg.deploymentId}`,
method: DELETE,
params: {
deploymentId: queryArg.deploymentId
}})}),
getApiDeploymentsDeploymentIdBuildLogs: build.query<GetApiDeploymentsDeploymentIdBuildLogsResponse,GetApiDeploymentsDeploymentIdBuildLogsResponse>
    ({query: (queryArg) => ({path: `/deployments/${queryArg.deploymentId}/build_logs`,
method: GET,
params: {
deploymentId: queryArg.deploymentId
}})}),
getApiDeploymentsDeploymentIdAppLogs: build.query<GetApiDeploymentsDeploymentIdAppLogsResponse,GetApiDeploymentsDeploymentIdAppLogsResponse>
    ({query: (queryArg) => ({path: `/deployments/${queryArg.deploymentId}/app_logs`,
method: GET,
params: {
q: queryArg.q,
...
getApiOrganizationsOrganizationIdDomains: build.query<GetApiOrganizationsOrganizationIdDomainsResponse,GetApiOrganizationsOrganizationIdDomainsResponse>
    ({query: (queryArg) => ({path: `/organizations/${queryArg.organizationId}/domains`,
method: GET,
params: {
page: queryArg.page,
limit: queryArg.limit,
...
postApiOrganizationsOrganizationIdDomains: build.mutation<PostApiOrganizationsOrganizationIdDomainsResponse,PostApiOrganizationsOrganizationIdDomainsResponse>
    ({query: (queryArg) => ({path: `/organizations/${queryArg.organizationId}/domains`,
method: POST,
params: {
organizationId: queryArg.organizationId
...
body: queryArg.body})}),
getApiDomainsDomainId: build.query<GetApiDomainsDomainIdResponse,GetApiDomainsDomainIdResponse>
    ({query: (queryArg) => ({path: `/domains/${queryArg.domainId}`,
method: GET,
params: {
domainId: queryArg.domainId
}})}),
deleteApiDomainsDomainId: build.mutation<DeleteApiDomainsDomainIdResponse,DeleteApiDomainsDomainIdResponse>
    ({query: (queryArg) => ({path: `/domains/${queryArg.domainId}`,
method: DELETE,
params: {
domainId: queryArg.domainId
}})}),
patchApiDomainsDomainId: build.mutation<PatchApiDomainsDomainIdResponse,PatchApiDomainsDomainIdResponse>
    ({query: (queryArg) => ({path: `/domains/${queryArg.domainId}`,
method: PATCH,
params: {
domainId: queryArg.domainId
...
body: queryArg.body})}),
postApiDomainsDomainIdVerify: build.mutation<PostApiDomainsDomainIdVerifyResponse,PostApiDomainsDomainIdVerifyResponse>
    ({query: (queryArg) => ({path: `/domains/${queryArg.domainId}/verify`,
method: POST,
params: {
domainId: queryArg.domainId
}})}),
postApiDomainsDomainIdCertificates: build.mutation<PostApiDomainsDomainIdCertificatesResponse,PostApiDomainsDomainIdCertificatesResponse>
    ({query: (queryArg) => ({path: `/domains/${queryArg.domainId}/certificates`,
method: POST,
params: {
domainId: queryArg.domainId
},
body: queryArg.body})}),
postApiDomainsDomainIdCertificatesProvision: build.mutation<PostApiDomainsDomainIdCertificatesProvisionResponse,PostApiDomainsDomainIdCertificatesProvisionResponse>
    ({query: (queryArg) => ({path: `/domains/${queryArg.domainId}/certificates/provision`,
method: POST,
params: {
domainId: queryArg.domainId
}})})}),
