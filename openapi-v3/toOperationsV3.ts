...
import { OasOperation } from '../oas-elements/Operation.ts'
import type { OperationFields } from '../oas-elements/Operation.ts'
import { toPathItemV3 } from './toPathItemV3.ts'
import type { OasPathItem } from '../oas-elements/PathItem.ts'
