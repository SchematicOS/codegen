import type { OasContactData, OasLicenseData } from '../oasTypes/types.ts'
import type { OpenAPIV3 } from 'openapi-types'
import type { Trail } from '../context/Trail.ts'
import type { CoreContext } from '../context/CoreContext.ts'
import { OasInfo } from '../oasElements/Info.ts'
import type { InfoFields } from '../oasElements/Info.ts'
