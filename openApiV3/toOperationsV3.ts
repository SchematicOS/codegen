...
import { OasOperation } from '../oasElements/Operation.ts'
import type { OperationFields } from '../oasElements/Operation.ts'
import { toPathItemV3 } from './toPathItemV3.ts'
import type { OasPathItem } from '../oasElements/PathItem.ts'
